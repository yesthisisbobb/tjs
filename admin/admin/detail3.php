...
if($_POST['rowid'])
    ...
    $sql = "SELECT * FROM ijual where no='$id'";
    ...
    ?>
    <form action="update-so-i.php" method="post">
<div class="row">
...
<div class="form-group">
	<label class="col-sm-2 control-label">SO Indent No.</label>
<div class="col-sm-10">
...
<tbody>
			<?php
			$sql1 = "SELECT * FROM ijualdtl where no_cart='$sono'";
            ...
            while($amkutipe = mysqli_fetch_array($querytipe)){
              $kodetipeku=$amkutipe['kodeitem_stok'];
					...
					$t=$t+1;
					$gt=$gt+$total;
						$sqlbot = "SELECT * FROM master_hpp where tjscode='$kodestok'";
			...
			<tr>
				...
				<td><input size="50" type="text" readonly name="kode[]" value="<?php echo $kodetipeku; ?>"></td>
...
<tfooter>
	...
	<?php } else if($pengguna["role"]=="admin") { ?>

		<td></td><td></td><td></td><td>Total</td><td><input size="15" type="text" readonly id="gt" value="<?php echo $gt; ?>"></td>
	<?php }?>
	</tr>
	<?php
	  if ($pengguna["role"]=="manager")
...
<?php } else if ($pengguna["role"]=="admin") {?>
	<tr>
		<td></td><td></td><td></td><td>Disc</td><td><input readonly size="15" id="dis1" name="dis1" type="text"  value="<?php echo $disitem; ?>"></td>
	</tr>
	<tr>
		<td></td><td></td><td></td><td>Grand Total</td><td><input size="15" id="grand" name="grand" onfocus="hitung()" type="text"  value="<?php echo $grandtotal1; ?>"></td>
	</tr>
	<tr>
			<td></td><td></td><td></td><td>Down Payment</td><td><input size="15" name="payment" id="payment" type="text" value="<?php echo $bayar; ?>"></td>
		</tr>
		<tr>
				<td></td><td></td><td></td><td>Balance</td><td><input size="15" id="kembali" name="kembali" onfocus="bayar()" type="text" value="<?php echo $kembali; ?>"></td>
			</tr>
	<?php }
?>
...
function bayar()
{
	...
	document.getElementById("kembali").value=document.getElementById("grand").value-document.getElementById("payment").value;
	// if (document.getElementById("grand").value <= document.getElementById("gran1").value)
	// {
	//
	// }
