...
<div class="container">
        ...
        <!-- <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">SO No.</li>
        </ol> -->
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <?php
        $nomer=$_GET['no'];
         ?>
        <h1 class="page-header">SO No.<?php echo $nomer; ?></h1>
      ...
      <table class="table table-striped">
          ...
          $no=0;
              $sql = "SELECT * FROM jualdtl where no_cart='$nomer'";
                 ...
                 while($amku = mysqli_fetch_array($query)){
                   ...
                   $sql22 = "SELECT * FROM master_stok where kode_stok='$kodestok'";
                      $query22 = mysqli_query($conn, $sql22);
                      while($amku22 = mysqli_fetch_array($query22)){
                        $kodeitem=$amku22['kodeitem_stok'];
}
            ?>
        ...
        <tfooter>
        	<tr>
        		...
        		<td></td><td></td><td></td><td>Total</td><td><?php echo rupiah($totalku); ?></td>
        	...
        	<tr>
        			<td></td><td></td><td></td><td>Payment</td><td><?php echo rupiah($bayarku); ?></td>
        		</tr>
        		<tr>
        			<td></td>	<td></td><td></td><td>Change</td><td><?php echo rupiah($kembaliku); ?></td>
        			</tr>
