...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Incoming SO Indent</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Incoming Sales Order(SO) Indent </h1>
                      ...
                      <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title">View/Edit Sales Order Indent</h4>
                          </div>
