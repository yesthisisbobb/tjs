...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Agent Fee</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Agent Fee<a href="master_agent.php" class="btn btn-primary btn btn-sm" role="button"><i class="fa fa-plus"></i></a></h1>
        ...
        <table id="data-table-buttons" class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th class="text-nowrap">Min Buy Price</th>
              <th class="text-nowrap">Max Bu  Price</th>
              <th class="text-nowrap">Agent Fee</th>
              <th class="text-nowrap">%Agent Tax</th>
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="with-btn" nowrap="">
                ...
                <a href="master_agent.php?aksi=view&no=<?php echo $amku["id"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-pencil-alt"></i></a>
                      ...
                      <button type="submit" name="daftar1" value="daftar1" class="btn btn-default">Update</button>
                        <?php } else { ?>
                          ...
                          <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                            <!-- begin panel-heading -->
                            <div class="panel-heading">
                              <h4 class="panel-title">Add New Agent Fee</h4>
                            </div>
                            <!-- end panel-heading -->
                            <!-- begin panel-body -->
                            <div class="panel-body panel-form">
   ...
   <option value="ZW">Zimbabwe</option>
               ...
               <div class="row">
                       ...
                       <div class="col-sm-2">
                          <div class="form-group">
                       <input type="text" class="form-control" id="persen" name="persen" placeholder="% AgentTax">
                     </div>
                     </div>
                       </div>
                       <div class="row">
                                      ...
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Add New Role For Agent Fee Cost</h4>
                                          </div>
