...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Section Gudang/li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Section Gudang</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Section Gudang</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body panel-form">
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-cell.php">
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Gudang</label>
                            <div class="col-sm-2">
                              <select class="form-control" id="gudang" name="gudang">
                                <option>Nama Gudang</option>
                            				<?php
                            					$sql = "SELECT * FROM gudang";
                                   				 $query = mysqli_query($conn, $sql);
                                    			 while($amku = mysqli_fetch_array($query)){
                            							echo '<option>'.$amku['nm_gudang'].'</option>';
                            						}
                            					?>
                                </select>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-6 control-label">Section No.</label>
                              <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-6 control-label">Kapasitas(Pallet)</label>
                                <div class="col-sm-6">
