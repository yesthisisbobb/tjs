        ...
        <table id="data-table-buttons" class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th class="text-nowrap">Sales Incentive Cost</th>
              <th class="text-nowrap">Fixed Cost</th>
              <th class="text-nowrap">Reserve Profit Cost</th>
              <th class="text-nowrap">Allowance</th>
                                        ...
                                        <div class="col-sm-4">
                                          ...
                                          <!-- <script type="text/javascript">
                                            $(document).ready(function(){
                                              ...
                                              <div class="row">
                                                <div class="col-sm-4">
                                                <input type="text" class="bundar form-control" id="sc" name="sc" placeholder="Showroom Cost">

                                              </div>

                                                  <div class="col-sm-4">
                                                  <input type="text" class="bundar form-control" id="tc" name="tc" placeholder="Sales Travel Cost">
                                                </div>
                                                <div class="col-sm-4">
                                                  <input type="text" class="bundar form-control" id="mc" name="mc" placeholder="Marketing Cost">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-sm-4">
                                                <input type="text" class="bundar form-control" id="sic" name="sic" placeholder="Sales Incentive Cost">
                                            </div>
                                            <div class="col-sm-2">
                                              <input type="text" class="bundar form-control" id="fc" name="fc" placeholder="Fixed Cost">
                                          </div>
                                          <div class="col-sm-4">
                                            <input type="text" class="bundar form-control" id="rpc" name="rpc" placeholder="Reserve Profit Cost">
                                        </div>
                                        <div class="col-sm-2">
                                          <input type="text" class="bundar form-control" id="allow" name="allow" placeholder="Allowance">
                                      </div>
