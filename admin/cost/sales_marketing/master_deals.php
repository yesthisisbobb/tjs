        ...
        <ul class="navbar-item flex-row">
            <li class="nav-item align-self-center page-heading">
                <div class="page-header">
                    <h4 class="text-info"> Deals <span style="font-size:12px;">Penawaran </span><a href="master_deals.php#section2" class="btn btn-info btn-sm" role="button">Add New</a></h4></h4>                    
                </div>
            </li>
        </ul>
              ...
              <div class="row layout-top-spacing">
                ...
                <table id="zero-config" class="cell-border table table-hover">
                  ...
                  <tbody>
                     ...
                     <?php
                      ...
                      $sql = "SELECT d.id AS kode, kr.email, d.data_create as tgl, d.keterangan AS ket, d.name AS nama_deal, d.value AS value_deal, k.nama AS nama_kontak, k.telp AS telp, k.email AS email, k.perusahaan AS perusahaan, s.id AS stage_id, s.name AS stage_name, d.closing_date AS closing FROM kontak k
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td>
                        ...
                        if($amku['stage_id'] == "1")
                        {
                          echo "<span class='badge badge-info' style='font-size: 10px;'>Lead In</span>";
                        }
                        else if($amku['stage_id'] == "2")
                        {
                          echo "<span class='badge badge-secondary' style='font-size: 10px;'>Qualified To Buy</span>";
                        }
                        else if($amku['stage_id'] == "3")
                        {
                          echo "<span class='badge badge-primary' style='font-size: 10px;'>Presentation Scheduled</span>";
                        }
                        else if($amku['stage_id'] == "4")
                        {
                          echo "<a href='#'><span class='badge badge-dark' style='font-size: 10px;'>Quotation</span></a>";
                        }
                        else if($amku['stage_id'] == "5")
                        {
                          echo "<span class='badge badge-danger' style='font-size: 10px;'>Negotiation</span>";
                        } 
                        else
                        {
                          echo "<span class='badge badge-success' style='font-size: 10px;'>Closed Won</span>";
                        }                       
                        ?>
                ...
                <div>
                  <div class="form-group">
                    <div class="col-sm-3">
                      <label class="control-label" style = "font-size: 12px;">Check Progress Target</label>
                      <select class="form-control" id="check_target" name="check_target" style = "font-size: 12px;">                                     
                        <?php 
                    ...
                    <div class="col-sm-4" style="margin-top: -39px;">
                      <a href="proses-master-deals.php?aksi=check" class="btn btn-primary" style="float: right;">Check</a></span>          
                    </div>                                            
                  </div>
                  <div>
                    <!-- Tabel -->
