        ...
        <ul class="navbar-item flex-row">
            <li class="nav-item align-self-center page-heading">
                <div class="page-header">
                    <h4 class="text-info"> Team <span style="font-size:12px;">Tim </span><a href="master_team.php#section2" class="btn btn-info btn-sm" role="button">Add New</a></h4></h4>                    
                </div>
            </li>
        </ul>
                ...
                <table id="zero-config" class="cell-border table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-wrap text-left">Detail</th>   
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td><a href="team_detail.php?no=<?php echo $amku["kode"]; ?>" class="btn btn-primary" style="font-size: 10px;">Show</a></td>
                      ...
                      <td class="with-btn" nowrap="">
                        ...
                        <a href="proses-master-stage.php?aksi=delete&no=<?php echo $amku["id"]; ?>"><i class="fas fa-trash" style="font-size:18px;color:#CD6155;"data-toggle="tooltip" title="DELETE" ></i></a>                        
                      </td>
                   <?php } ?>
                    </tr>
                  </tbody>
                                    ...
                                    <form class="form-horizontal" method="post" action="proses-master-team.php">
                                         <?php
                                            ...
                                            if ($aksi =="view")
                                            {
                                              ...
                                              $sql = "SELECT t.kode AS kode, t.data_create AS tgl, t.name AS tim, l.nama AS manager, t.target AS target, t.region AS region, t.status AS status_tim FROM master_team t
                                                      INNER JOIN login l ON t.id_manager = l.id
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container">
                                              ...
                                              <div class="form-group">
                                                 ...
                                                 <div class="col-sm-4">
                                                   <input type="text" class="form-control" id="tim_name" value="<?php echo $tim; ?>" name="tim_name" disabled>
                                                </div>
                                              </div>
                                              <div class="form-group">
                                        ...
                                        <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container"><br>
                                                    <div class="form-group">
                                                        <label class="col-sm-6 control-label">Team Name</label>
                                                        <div class="col-sm-4">
                                                            <input type="text" class="form-control" id="date_activity2" name="date_activity2">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                      <label class="col-sm-6 control-label">Manager</label>
                                                      <div class="col-sm-3">
                                                  ...
                                                  <div class="form-group">
                                                      <label class="col-sm-6 control-label">Value Target - Rp</label>
                                                      <div class="col-sm-3">
                                                          <input type="text" class="form-control" id="value_target" name="value_target" placeholder="Rp ...">
                                                      </div>
                                                  </div>
                                                  <br>
                                      <div class="row">
