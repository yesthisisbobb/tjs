        ...
        <ul class="navbar-item flex-row">
            <li class="nav-item align-self-center page-heading">
                <div class="page-header">
                    <h4 class="text-info"> Team of Sales <span style="font-size:12px;">Tim Penjualan </span><a href="master_stage.php#section2" class="btn btn-info btn-sm" role="button">Add New</a></h4></h4>                    
                </div>
            </li>
        </ul>
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="with-btn" nowrap="">
                        ...
                        <a href="proses-master-stage.php?aksi=delete&no=<?php echo $amku["kode"]; ?>"><i class="fas fa-trash" style="font-size:18px;color:#CD6155;"data-toggle="tooltip" title="DELETE" ></i></a>                        
                      </td>
                   <?php } ?>
                    </tr>
                  </tbody>
                                ...
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12 border-bottom border-info 1px">
                                  ...
                                  <div class="col-lg-12 col-12 mx-auto">
                                    ...
                                    <form class="form-horizontal" method="post" action="proses-master-activities.php">
                                        ...
                                        <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container">
                                              ...
                                              <div class="form-group">
                                                 <label class="col-sm-10 control-label">Sales Name</label>
                                                 <div class="col-sm-4">
                                                   <input type="text" class="form-control" id="name" value="<?php echo $sales; ?>" name="name">
                                                </div>
                                              </div>
                                                <div>
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-6 control-label">Value Target</label>
                                            <div class="col-sm-6">
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container"><br>
                                                  ...
                                                  <div class="form-group">
                                                        ...
                                                        <div class="col-sm-4">
                                                          <input type="text" class="form-control" id="region2" name="region2" placeholder="Region">
                                                        </div>
                                                  </div>                                                    
                                                  <div class="form-group">
                                                      <label class="col-sm-6 control-label">Value Target - Rp (Nilai Target)</label>
                                                      <div class="col-sm-4">
                                                          <input type="text" class="form-control" id="value2" name="value2" placeholder="Rp ...">
                                                      </div>
                                                  </div>
                                                  <br>
                                      <div class="row">
