...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Currency</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Currency <a href="master_cur.php" class="btn btn-primary btn btn-sm" role="button"><i class="fa fa-plus"></i></a></h1>
        ...
        <table id="data-table-buttons" class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th class="text-nowrap">Currency code</th>
              <th class="text-nowrap">Currency Name</th>
          ...
          <tbody>
            ...
            <?php
              $sql = "SELECT * FROM master_cur where status='Active' ORDER BY id ASC";
            ...
            <tr class="odd gradeX">
              ...
              <td class="with-btn" nowrap="">
                ...
                <a href="master_cur.php?aksi=view&no=<?php echo $amku["id"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-pencil-alt"></i></a>
            ...
            <div class="row">
              <div class="col-lg-12">
                      <form class="form-horizontal" method="post" action="proses-master-grup.php">
                        ...
                        {
                          $nomerku=$_GET['no'];
                          $sql = "SELECT * FROM master_cur where id='$nomerku'";
                               $query = mysqli_query($conn, $sql);
                               while($amku = mysqli_fetch_array($query)){
                                 $kodep=$amku['kode'];
                                 $namap=$amku['nama'];
                         ...
                         <div class="form-group">
                           <label class="col-sm-10 control-label">Currenct Code</label>
                           <div class="col-sm-2">
                          ...
                          <div>
                          <div class="form-group">
                            <label class="col-sm-6 control-label">Currency  Name</label>
                          <div class="col-sm-6">
                   ...
                   <div class="form-group">
                     <div class="col-sm-4">
                       <input type="text" class="form-control" id="kode" name="kode" placeholder="Currency Code">
                     </div>
                   </div>
                     <div class="form-group">
                      <div class="col-sm-12">
                      <input type="text" class="form-control" id="nama" name="nama" placeholder="Currency Name">
                    </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
