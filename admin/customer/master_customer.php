...
?>
      ...
      <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Customer Project <a href="master_tipe.php" class="bundar btn btn-info btn btn-sm" role="button">Add</a></h1>
        ...
        <table id="data-table-buttons" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <?php
              $sql = "SELECT * FROM customerp where status= 'Active' ORDER BY id";
  ...
  <form class="form-horizontal" method="post" action="proses-cust.php">
                              <?php
                              $aksi=$_GET['aksi'];
                              if ($aksi=="view")
                              {
                              ...
                              <?php } else { ?>
                                ...
                                <div class="tab-content" id="myTabContent">
                                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      ...
                                      <hr>
                                      <div class="form-group">
                                          <label class="col-sm-8 control-label">Customer Name<font color="red"><i> *required</i></font></label>
                                          <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                            <input type="text" class="bundar form-control" id="alamat" name="alamat">
                                              <span><font color="Red">*Leave Empty if not applied</font></span>
                                          </div>
                                          </div>
                                          <div class="form-group">
                                              <label class="col-sm-4 control-label">Phone</label>
                                              <div class="col-sm-4">
                                              <input type="text" class="bundar form-control" id="telpon" name="telpon">
                                                <span><font color="Red">*Leave Empty if not applied</font></span>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-4">
                                                  <input type="text" class="bundar form-control" id="pic" name="pic">
                                                  <span><font color="Red">*Leave Empty if no available value</font></span>
                                                </div>
                                                </div>
