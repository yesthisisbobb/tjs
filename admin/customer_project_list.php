...
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Customer Project</button>
        <!-- end page-header -->
...
<!-- begin panel -->
    ...
    <tbody>
       ...
       <?php
        $sql = "SELECT * FROM master_project";
        ...
        while($agen = mysqli_fetch_array($query)){
			...
			echo "<td>".$agen['nm_grup']."</td>";
			echo "<td>".$agen['AR_limit']."</td>";
			echo "<td>".$agen['alamat']."</td>";
            echo "<td>".$agen['kota']."</td>";
            echo "<td>".$agen['telp']."</td>";
            echo "<td>".$agen['email']."</td>";
			echo "<td>".$agen['pic']."</td>";
            echo "<td>".$agen['sales']."</td>";
            echo "<td>".$agen['tgl_masuk']."</td>";
			echo "<td>".$agen['keterangan_BL']."</td>";
            echo "<td>".$agen['cabang']."</td>";
            echo "<td>";
            echo "<a href='form-updatelead.php?kode=".$agen['kode']."'>Update</a> | ";
			echo "<a href='customer_project_list_detail.php?kode=".$agen['ID_grup']."'>More..</a> | ";
