...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Customer Sub Project</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Customer Sub Project</h1>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Customer Sub Project</button>
        <!-- end page-header -->
...
<!-- begin panel -->
    ...
    <tbody>
       ...
       <?php
	   $kode =$_GET['kode'];
        $sql = "SELECT * FROM detail_project where ID_grup='$kode' ";
        ...
        while($agen = mysqli_fetch_array($query)){
			...
			echo "<td>".$agen['TOP']."</td>";
            echo "<td>";
            echo "<a href='customer_project_list.php'>Back to Main</a> | ";
			echo "<a href='customer_toko_list_detail.php?kode=".$agen['kode']."'>Update</a> | ";
