...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Funnel</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Funnel <a href="master_tipe.php" class="bundar btn btn-info btn btn-sm" role="button">Add</a></h1>
        ...
        <table id="data-table-buttons" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            <?php
              $sql = "SELECT * FROM master_sales ORDER BY no";
                              ...
                              <?php } else { ?>
                                ...
                                <div class="tab-content" id="myTabContent">
                                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      ...
                                      <hr>
                                      <div class="form-group">
                                          <label class="col-sm-8 control-label">Sales Name<font color="red"><i> *required</i></font></label>
                                          <div class="col-sm-12">
                                          <input type="text" class="bundar form-control" id="nama" name="nama" required>
                                        </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Branch<font color="red"><i> *required</i></font></label>
                                            <div class="col-sm-12">
                                            <input type="text" class="bundar form-control" id="cabang" name="cabang">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Email<font color="red"><i> *required</i></font></label>
                                                <div class="col-sm-4">
                                                <input type="text" class="bundar form-control" id="email" name="email">

                                              </div>
                                              </div>
                                              <div class="form-group">
                                                  <label class="col-sm-4 control-label">Password<font color="red"><i> *required</i></font></label>
                                                  <div class="col-sm-4">
                                                  <input type="text" class="bundar form-control" id="pass" name="pass">
