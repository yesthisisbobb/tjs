...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Divisi</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Divisi</h1>
            ...
            <div class="container">
              <table id="data-table-buttons" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php
                     $no = 1;
                     $pg = mysqli_query($conn,"SELECT * FROM divisi ORDER BY kode ASC");
