...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Product Grade</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Product Grade <a href="master_grade.php" class="btn btn-primary btn btn-sm" role="button"><i class="fa fa-plus"></i></a></h1>
        ...
        <table id="data-table-buttons" class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th class="text-nowrap">Product Grade code</th>
              <th class="text-nowrap">Product Grade</th>
          ...
          <tbody>
            ...
            <?php
              $sql = "SELECT * FROM master_grade where status='Active' ORDER BY id ASC";
            ...
            <tr class="odd gradeX">
              ...
              <td class="with-btn" nowrap="">
                ...
                <a href="master_grade.php?aksi=view&no=<?php echo $amku["id"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-pencil-alt"></i></a>
            ...
            <div class="row">
              <div class="col-lg-12">
                      <form class="form-horizontal" method="post" action="proses-master-grup.php">
                        ...
                        {
                          $nomerku=$_GET['no'];
                          $sql = "SELECT * FROM master_grade where id='$nomerku'";
                               $query = mysqli_query($conn, $sql);
                               while($amku = mysqli_fetch_array($query)){
                                 $kodep=$amku['kode'];
                                 $namap=$amku['nama'];
                          ...
                          <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                            ...
                            <div class="panel-heading">
                              <h4 class="panel-title">View/Update Product Grade</h4>
                            </div>
                            <!-- end panel-heading -->
                            <!-- begin panel-body -->
                         ...
                         <div class="form-group">
                           <label class="col-sm-10 control-label">Product Grade Code</label>
                           <div class="col-sm-2">
                          ...
                          <div>
                          <div class="form-group">
                            <label class="col-sm-6 control-label">Prooduct Grade Name</label>
                          <div class="col-sm-6">
                      ...
                      <button type="submit" name="daftar1" value="daftar1" class="btn btn-default">Update</button>
                        <?php } else { ?>
                          ...
                          <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                            <!-- begin panel-heading -->
                            <div class="panel-heading">
                              <h4 class="panel-title">Add Product Grade</h4>
                            </div>
                            <!-- end panel-heading -->
                            <!-- begin panel-body -->
                            <div class="panel-body panel-form">
                   ...
                   <div class="form-group">
                     <div class="col-sm-4">
                       <input type="text" class="form-control" id="kode" name="kode" placeholder="Product Grade Code">
                     </div>
                   </div>
                     <div class="form-group">
                      <div class="col-sm-12">
                      <input type="text" class="form-control" id="nama" name="nama" placeholder="Product Grade Name">
                    </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
