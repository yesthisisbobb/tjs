              ...
              <div class="row layout-top-spacing">
                          ...
                          <div class="widget-header">
                              <div class="row">
                                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                      <h4>EMKL  <a href="master_emkl.php#section2" class="btn  btn-rounded btn-primary btn-sm" role="button">Add New</a></h4>
                                  </div>
                              </div>
                          </div>
                          <hr>
                ...
                <table id="zero-config" class="table table-hover" style="width:100%">
                  <thead>
                    <tr>
                      <!-- <th width="1%">No</th> -->
                      <th class="text-wrap">Division</th>
                      <th class="text-wrap">Import System</th>
                      <th class="text-wrap">Depart Port</th>
                      <th class="text-wrap">Dest Port</th>
                      <th class="text-wrap">Cont Type</th>
                      <th class="text-wrap">EMKL Cost</th>
                  ...
                  <tbody>
                    ...
                    <?php
                      $sql = "SELECT * FROM master_emkl ORDER BY no";
                           $query = mysqli_query($conn, $sql);
                           while($amku = mysqli_fetch_array($query)){
                      ?>
                    <tr class="odd gradeX">
                      <td><?=$amku["koded"];?></td>
                      <td><?=$amku["import_system"];?></td>
                      <td><?=$amku["pod"];?></td>
                      <td><?=$amku["tujuan"];?></td>
                      <td><?=$amku["conttype"];?></td>
                      <td class="text-nowrap"><?=rupiah($amku["biaya"]);?></td>
                      <td><?=$amku["status"];?></td>
                      <td class="with-btn" nowrap="">

                        <a href="master_emkl.php?aksi=view&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn btn-sm" role="button">Edit</a>
                        <!-- <a href="#" class="btn btn-primary" role="button"><i class="fa fa-pencil-alt"></i></a> -->

                          <a href="proses_emkl.php?aksi=update&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn btn-sm" role="button">Disable</a>
                          <a href="proses_emkl.php?aksi=active&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn btn-sm" role="button">Enable</a>
                        <a href="proses_emkl.php?aksi=delete&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn btn-sm" role="button">Delete</a>
                      ...
                      <div class="statbox widget box box-shadow">
                        ...
                        <hr>
                                  ...
                                  <div class="col-lg-12 col-12 mx-auto">
                                    <form class="form-horizontal" method="post" action="proses_emkl.php">
                                      <?php
                                      $aksi=$_GET['aksi'];
                                      if ($aksi=="view")
                                      {
                                        $nomerku=$_GET['no'];
                                        $sql = "SELECT * FROM master_emkl where no='$nomerku'";
                                             $query = mysqli_query($conn, $sql);
                                             while($amku = mysqli_fetch_array($query)){
                                               $pod=$amku['pod'];
                                               $tujuan=$amku['tujuan'];
                                        ...
                                        <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container">
                                             ...
                                             <div class="form-group">
                                               <label class="col-sm-6 control-label">IS/label>
                                               <div class="col-sm-4">
                                             <select name="is" id="is" class="form-control">
                                               <option><?php echo $is ?></option>
                                             <?php
                                        ...
                                        <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container">
                                              ...
                                              <div class="form-group">
                                                <div class="col-sm-4">
                                                  <select name="koded" id="koded" class="form-control">
                                                  <?php
                                                    $sql = "SELECT * FROM master_perusahaan";
                                                         $query = mysqli_query($conn, $sql);
                                                         while($amku = mysqli_fetch_array($query)){
                                              ...
                                              <div class="form-group">
                                                <label class="col-sm-6 control-label">Import System</label>
                                                <div class="col-sm-4">
                                                <select name="is" id="is" class="form-control">
                                                  <option>Choose Import System</option>
                                                <?php
                                                  $sql = "SELECT * FROM master_is";
                                                       $query = mysqli_query($conn, $sql);
                                                       while($amku = mysqli_fetch_array($query)){
                ...
                <option value="ZW">Zimbabwe</option>
                               ...
                               <div class="form-group">
                                <label class="col-sm-6 control-label">EMKL Cost</label>
                                <div class="col-sm-6">
