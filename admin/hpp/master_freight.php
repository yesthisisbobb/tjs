                ...
                <table id="zero-config" class="table table-hover" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="text-wrap">Port of Discharge</th>
                      <th class="text-wrap">Destination Port</th>
                      <th class="text-wrap">Container Type</th>
                      <th class="text-wrap">Ship Type</th>
                      <th class="text-wrap">Freight Cost</th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="with-btn" nowrap="">
                        ...
                        <a href="master_freight.php?aksi=view&no=<?php echo $amku["no"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
                        ...
                        $sqluk = "SELECT * FROM login where email='$uk'";
                          ...
                          {
                         ?>
                          <a href="proses_freight.php?aksi=update&no=<?php echo $amku["no"]; ?>"><i class="fas fa-times-circle"  style="font-size:18px;color:#F8C471;"data-toggle="tooltip" title="DISABLE" ></i></a>
                          <a href="proses_freightp.php?aksi=active&no=<?php echo $amku["no"]; ?>"><i class="fas fa-check-circle" style="font-size:18px;color:#52BE80;"data-toggle="tooltip" title="ENABLE" ></i></i></a>
                        <a href="proses_freight.php?aksi=delete&no=<?php echo $amku["no"]; ?>"><i class="fas fa-trash" style="font-size:18px;color:#CD6155;"data-toggle="tooltip" title="DELETE" ></i></i></a>
                        <?php } else { ?>
