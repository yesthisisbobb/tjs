                          ...
                          <div class="widget-header">
                              <div class="row">
                                  <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                      <h4>Import System  <a href="master_is.php#section2" class="btn  btn-rounded btn-primary btn-sm" role="button">Add New</a></h4>
                                  </div>
                              </div>
                          </div>
                          <hr>
                ...
                <table id="zero-config" class="table table-hover" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="text-wrap">Import System Code</th>
                      <th class="text-wrap">Import System Type</th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="with-btn" nowrap="">
                        ...
                        <a href="master_is.php?aksi=view&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn-sm" role="button">Edit</a>
                        <!-- <a href="#" class="btn btn-primary" role="button"><i class="fa fa-pencil-alt"></i></a> -->

                          <a href="proses-is.php?aksi=update&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn-sm" role="button">Disable</a>
                          <a href="proses-is.php?aksi=active&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn-sm" role="button">Enable</a>
                        <a href="proses-is.php?aksi=delete&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn-rounded btn-sm" role="button">DELETE</a>
