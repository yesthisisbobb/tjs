                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="with-btn" nowrap="">
                        ...
                        <a href="master_hscode.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
...
<br>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <div class="col-sm-12">
                                    Product Group (Grup Produk)
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Product Group">
                                  </div>
                                  </div>
                                  <div class="form-group">
                                   <div class="col-sm-12">
                                     Description
                                   <input type="text" class="form-control" id="nama1" name="nama1" placeholder="Description">
                                 </div>
                                 </div>
                                  <div class="form-group">
                                      <div class="col-sm-4">
