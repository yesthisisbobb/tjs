          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              <td class="with-btn" nowrap="">
                ...
                <a href="master_stok.php?aksi=view&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-pencil-alt"></i></a>
                <!-- <a href="#" class="btn btn-primary" role="button"><i class="fa fa-pencil-alt"></i></a> -->

                  <a href="proses-stok.php?aksi=update&no=<?php echo $amku["no"]; ?>" class="btn btn-danger btn btn-xs" role="button"><i class="fa fa-minus"></i></a>
                  <a href="proses-stok.php?aksi=active&no=<?php echo $amku["no"]; ?>" class="btn btn-success btn btn-xs" role="button"><i class="fa fa-check"></i></a>
                <a href="proses-stok.php?aksi=delete&no=<?php echo $amku["no"]; ?>" class="btn btn-danger btn btn-xs" role="button"><i class="fa fa-trash"></i></a>
                                      ...
                                      <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                              ...
                                              <?php
                                                $sql = "SELECT * FROM country";
                                                     $query = mysqli_query($conn, $sql);
                                                     while($amku = mysqli_fetch_array($query)){
                                                    echo "<option value=".$amku['countrycode'].">".$amku['countryname']."</option>";
                                                  }
                                                ?>
                                              </select>
                                                <span><font color="Red">*Required</font></span>
                                        ...
                                        <div class="tab-pane fade" id="att" role="tabpanel" aria-labelledby="att-tab">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-sm-3">
                                                <div class="form-group">
                                              <input type="text" class="form-control" id="ctnpallet" name="ctnpallet" placeholder="Carton/Pallet">
                                              <span><font color="Red">*Tile Product</font></span>
                                            </div>
                                            </div>
