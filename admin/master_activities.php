        ...
        <ul class="navbar-item flex-row">
            <li class="nav-item align-self-center page-heading">
                <div class="page-header">
                    <h4 class="text-info"> Activities <span style="font-size:12px;">Kegiatan </span><a href="master_activities.php?aksi#section2" class="btn btn-info btn-sm" role="button">Add New</a></h4></h4>                    
                </div>
            </li>
        </ul>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="with-btn" nowrap="">
                        <?php 
                            ...
                            {
                                echo '<a href="master_activities.php?aksi=view&no='.$amku["kode"].'#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>';
                                ...
                                echo '<a href="proses-master-grup.php?aksi=update&no='.$amku["kode"].'"><i class="fas fa-times-circle"  style="font-size:18px;color:#F8C471;"data-toggle="tooltip" title="DISABLE" ></i></a>';
                            }
                        ?>
                          </td>
                   <?php } ?>
