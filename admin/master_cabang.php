...
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Data Cabang</button>
        <!-- end page-header -->
          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Data Master Cabang</h4>
