         ...
         <ul class="navbar-item flex-row">
             <li class="nav-item align-self-center page-heading">
                 <div class="page-header">
                        ...
                        <h4 style="color:#5DADE2;">COLOR <span style="font-size:12px;">Warna</span> <a href="master_color.php#section2" class="btn btn-info btn-sm" role="button">Add New</a></h4>
                ...
                <table id="zero-config" class="table table-hover" style="width:100%">
                  <thead>
                    <tr>
                      ...
                      <th class="text-nowrap">Colour code</th>
                      <th class="text-nowrap">Colour Name</th>
                  ...
                  <tbody>
                    ...
                    <?php
                      $sql = "SELECT * FROM master_color where status='Active' ORDER BY id ASC";
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="with-btn" nowrap="">
                        ...
                        <a href="master_color.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
...
<br>
                                  ...
                                  <div class="col-lg-12 col-12 mx-auto">
                                    <form class="form-horizontal" method="post" action="proses-master-grup.php">
                                      ...
                                      {
                                        $nomerku=$_GET['no'];
                                        $sql = "SELECT * FROM master_color where id='$nomerku'";
                                             $query = mysqli_query($conn, $sql);
                                             while($amku = mysqli_fetch_array($query)){
                                               $kodep=$amku['kode'];
                                               $namap=$amku['nama'];
                                       ...
                                       <div class="form-group">
                                         <label class="col-sm-10 control-label">Color Code (Kode Warna)</label>
                                         <div class="col-sm-6">
                                        ...
                                        <div>
                                        <div class="form-group">
                                          <label class="col-sm-6 control-label">Color Name (Warna)</label>
                                        <div class="col-sm-6">
                                 ...
                                 <div class="form-group">
                                   <div class="col-sm-6">
                                     ...
                                     <input type="text" class="form-control" id="kode" name="kode" placeholder="Color Code">
                                   </div>
                                 </div>
                                   <div class="form-group">
                                    <div class="col-sm-6">
                                      Color Name (Warna)
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Color Name">
                                  </div>
                                  </div>
                                  <div class="form-group">
                                      <div class="col-sm-4">
  ...
  <div class="footer-wrapper">
      <div class="footer-section f-section-1">
          <p class="">Copyright © 2020 SmartMarbleAndBath, All rights reserved.</p>
      </div>
