...
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Data Gudang</button>
     <button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Update Data Gudang</button>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Hapus Data Gudang</button>
          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <BR>
				 ...
				 <tr><td height="50"><label for="kota">Keterangan</label></td><td><input required size="50" type="text" name="kota" id="kota" /></td>
