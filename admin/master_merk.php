...
?>  
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Merk/li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Merk</h1>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Data Merk</button>
     <button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Update Data Merk</button>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Hapus Data Merk</button>
          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <BR>
				  ...
				  <tr><td height="30"> Kode Merk </td>
				  <td> <input type="text"></td>
				  <tr><td height="30"> Nama Merk </td>
