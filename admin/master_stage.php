        ...
        <ul class="navbar-item flex-row">
            <li class="nav-item align-self-center page-heading">
                <div class="page-header">
                    <h4 class="text-info"> Stage <span style="font-size:12px;">Tahap </span><a href="master_stage.php?aksi#section2" class="btn btn-info btn-sm" role="button">Add New</a></h4></h4>                    
                </div>
            </li>
        </ul>
                ...
                <table id="zero-config" class="cell-border table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-wrap text-left">Stage Code</th>
                      <th class="text-wrap text-left">Name</th>
                      <th class="text-wrap text-left">Percentage</th>
                  ...
                  <tbody>
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td><?=$amku["id"];?></td>
                      <td><?=$amku["name"];?></td>
                      <td><?=$amku["percentage"];?>%</td>


                      <td class="with-btn" nowrap="">
                        <a href="master_stage.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
                                    ...
                                    <form class="form-horizontal" method="post" action="proses-master-kontak.php">
                                        <?php
                                            ...
                                            if ($aksi =="view")
                                            {
                                              ...
                                              $sql = "SELECT * FROM deal_stage where id='$nomerku'";
                                                  $query = mysqli_query($conn, $sql);
                                                  while($amku = mysqli_fetch_array($query)){
                                                    $id =$amku['id'];
                                                    $name =$amku['name'];
                                                    $percentage =$amku['percentage'];
                                                  }
                                        ?>
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div>
                                                <div class="form-group">
                                                  <label class="col-sm-6 control-label">Percentage</label>
                                                <div class="col-sm-6">
                                                <input type="text" class="form-control" id="persentase" value="<?php echo $percentage; ?>" name="persentase">
                                              </div>
                                            </div><br>
                                                ...
                                                <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                                                  ...
                                                  <div class="panel-body panel-form">
                                                    <div class="container"><br>
                                                      <div class="form-group">
                                           <div class="col-sm-4">
                                             <input type="text" class="form-control" id="nama" name="nama2" placeholder="Stage's Name">
                                           </div>
                                         </div>
                                           <div class="form-group">
                                            <div class="col-sm-3">
                                            <input type="text" class="form-control" id="persentase2" name="persentase2" placeholder="Persentase (%)">
                                          </div>
                                          </div><br>
