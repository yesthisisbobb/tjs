...
?>  
      ...
      <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Supplier</h1>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Data Supplier</button>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Update Data Supplier</button>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Update Data Supplier</button>
          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <BR>
				  ...
				  <tr><td height="30"> Alamat Supplier </td>
				  <td><input size="40" type="text"></td>
				  <td> Kota </td>
				  <td> <input size="30" type="text"> </td></tr>
				  <tr><td height="30"> Negara </td>
				  <td><input size="30" type="text"></td>
				  <td> No.Telpon</td>
				  <td><input size="30" type="text"></td></td></tr>
				  <tr><td height="30"> Mobile Phone</td>
				  <td><input size="30" type="text"></td>
				  <td><label for="kota">Email</label></td><td><input required size="50" type="text" name="kota" id="kota" /></td>
				  <tr><td height="30"><label for="kota">Kontak</label></td><td><input required size="30" type="text" name="kota" id="kota" /></td>
				 <td><label for="kota">Kode Pos</label></td><td><input required size="10" type="text" name="kota" id="kota" /></td></tr>
				  <tr><td height="30"><label for="kota">AR Limit</label></td><td><input required size="30" type="text" name="kota" id="kota" /></td>
				  <td><label for="kota">TOP</label></td><td><input required size="20" type="text" name="kota" id="kota" /></td></tr>
				  <tr><td height="50"><label for="kota">Keterangan</label></td><td><input required size="30" type="text" name="kota" id="kota" /></td>
				  <td><label for="kota">Status</label></td>
				  <td>
				  <select>
				  <option>Aktif</option>
          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Data Master Supplier</h4>
