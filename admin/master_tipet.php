...
?>  
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Tipe Transport/li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Merk</h1>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Tipe Transport</button>
     <button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Update Tipe Transport</button>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Hapus Tipe Transport</button>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Tipe Transport</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
             ...
             <BR>
				  ...
				  <tr><td height="30"> Jenis Transport</td>
          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Data Master Tipe Transport</h4>
