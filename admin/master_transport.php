...
?>  
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Transpor</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Transport</h1>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Data Transport</button>
     <button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Update Data Transport</button>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Hapus Data Transport</button>
          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <BR>
				  ...
				  <tr><td height="30"> Kode Transport</td>
				  <td><input type="text"></td>
				  <tr><td height="30"> Jenis </td>
				  <td><select>
				  <option>Truk</option>
				  <option>Tronton</option>
				  <option>Elf</option>
				  </select></td>
				  <tr><td height="30"> Kapasitas muat (P x L)</td>
				  <td><input type="text" size="10">m2</td>
				  <td>Panjang <input type="text" size="10"></td>
				  <td>Lebar <input type="text" size="10"></td></tr>
				  
				  <tr><td height="30"> Kubikasi muat (P x L x T)</td>
				  <td><input type="text" size="10">m3</td>
				  <td>Panjang<input type="text" size="10"></td>
				  <td>Lebar<input type="text" size="10"></td>
				  <td>Tinggi<input type="text" size="10"></td></tr>
				  <tr><td height="30"> No.Kendaraan </td>		
				  <td><input size="30' type="text"></td>		   
				  <tr><td><label for="kota">Virtual/Not Virtual</label></td>
				  <td>
				  <select>
          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Data Master Transportasi</h4>
