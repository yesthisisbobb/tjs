...
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Tambah Data Ukuran</button>
     <button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Update Data Ukuran</button>
<button class="btn btn-md btn-primary m-b-30" onclick="myFunction()"><i class="fas fa-lg fa-fw m-r-10 fa-plus"></i>Hapus Data Ukuran</button>
          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <BR>
				  ...
				  <tr><td height="30"> Kode Ukuran </td>
				  <td> <input type="text"></td>
				  <tr><td height="30"> Nama Ukuran </td>
          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="panel-heading">
                ...
                <h4 class="panel-title">Data Master Ukuran</h4>
