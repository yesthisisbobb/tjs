                                    ...
                                    <table id="zero-config" class="table table-hover" style="width:100%">
                                      <thead>
                                        <tr>
                                          ...
                                          <th class="text-nowrap">Product Category code</th>
                                          <th class="text-nowrap">Product Category Name</th>
                                      ...
                                      <tbody>
                                        ...
                                        <?php
                                          $sql = "SELECT * FROM master_grup where status='Active' ORDER BY id ASC";
                                        ...
                                        <tr class="odd gradeX">
                                          ...
                                          <td class="with-btn" nowrap="">
                                            ...
                                            <a href="master_grup.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
                              ...
                              <br>
                                  <div class="col-lg-12 col-12 mx-auto">
                                    <form class="form-horizontal" method="post" action="proses-master-grup.php">
                                      ...
                                      {
                                        $nomerku=$_GET['no'];
                                        $sql = "SELECT * FROM master_grup where id='$nomerku'";
                                             $query = mysqli_query($conn, $sql);
                                             while($amku = mysqli_fetch_array($query)){
                                               $kodep=$amku['kode'];
                                               $namap=$amku['nama'];
                                       ...
                                       <div class="form-group">
                                         <label class="col-sm-10 control-label">Product Category Code (Kode Kategori Produk)</label>
                                         <div class="col-sm-12">
                                        ...
                                        <div>
                                        <div class="form-group">
                                          <label class="col-sm-6 control-label">Product Category Name (Kategori Produk)</label>
                                        <div class="col-sm-12">
                                 ...
                                 <div class="form-group">
                                   <div class="col-sm-12">
                                     Product Category Code (Kode Kategori Produk)
                                     <input type="text" class="form-control" id="kode" name="kode" placeholder="Product Category Code">
                                   </div>
                                 </div>
                                   <div class="form-group">
                                    <div class="col-sm-12">
                                      Product Category Name (Kategori Produk)
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Product Category Name">
                                  </div>
                                  </div>
                                  <div class="form-group">
                                      <div class="col-sm-4">
