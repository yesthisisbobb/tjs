          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="with-btn" nowrap="">
                ...
                <a href="master_grup.php?aksi=view&no=<?php echo $amku["id"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-pencil-alt"></i></a>
                        ...
                        if ($aksi=="view")
                        {
                          ...
                          <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                            ...
                            <div class="panel-heading">
                              <h4 class="panel-title">View/Update Product Category</h4>
                            </div>
                            <!-- end panel-heading -->
                            <!-- begin panel-body -->
                         ...
                         <div class="form-group">
                           <label class="col-sm-10 control-label">Product Category Code</label>
                           <div class="col-sm-2">
                          ...
                          <div>
                          <div class="form-group">
                            <label class="col-sm-6 control-label">Product Category Name</label>
                          <div class="col-sm-6">
