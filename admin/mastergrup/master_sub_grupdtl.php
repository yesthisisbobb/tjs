                                    ...
                                    <table id="zero-config" class="table table-hover" style="width:100%">
                                      <thead>
                                        <tr>
                                          ...
                                          <th class="text-nowrap">Product Sub Category Name</th>
                                          <th class="text-nowrap">Product Group Name</th>
                                      ...
                                      <tbody>
                                        ...
                                        <?php
                                          $sql = "SELECT * FROM detail_sub_grup where status='Active' ORDER BY id ASC";
                                        ...
                                        <tr class="odd gradeX">
                                          ...
                                          <td class="with-btn" nowrap="">
                                            ...
                                            <a href="master_sub_grupdtl.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
                                              <a href="proses-master-subgrupdtl.php?aksi=update&no=<?php echo $amku["id"]; ?>"><i class="fas fa-times-circle"  style="font-size:18px;color:#F8C471;"data-toggle="tooltip" title="DISABLE" ></i></a>
                                              <a href="proses-master-subgrupdtl.php?aksi=active&no=<?php echo $amku["id"]; ?>"><i class="fas fa-check-circle" style="font-size:18px;color:#52BE80;"data-toggle="tooltip" title="ENABLE" ></i></i></a>
                                            <a href="proses-master-subgrupdtl.php?aksi=delete&no=<?php echo $amku["id"]; ?>"><i class="fas fa-trash" style="font-size:18px;color:#CD6155;"data-toggle="tooltip" title="DELETE" ></i></i></a>
                        ...
                        <?php
                         ...
                         ?>
                           ...
                           <?php } else if ($aksi=="") { ?>
                             ...
                             <br>
                                  <div class="col-lg-12 col-12 mx-auto">
                                    <form class="form-horizontal" method="post" action="proses-master-subgrupdtl.php">
                                      <?php
                                      $aksi=$_GET['aksi'];
                                      if ($aksi=="view")
                                      {
                                        $nomerku=$_GET['no'];
                                        $sql = "SELECT * FROM detail_sub_grup where id='$nomerku'";
                                             $query = mysqli_query($conn, $sql);
                                             while($amku = mysqli_fetch_array($query)){
                                               $kodep=$amku['kode'];
                                               $namag=$amku['namagrup'];
                                          ...
                                          <div class="panel-body panel-form">
                                            <div class="container">
                                              <div class="form-group">
                                               ...
                                               <div>
                                                 <div class="form-group">
                                                     <label class="col-sm-8 control-label">Product Group Code (Kode Grup Produk)</label>
                                                     <div class="col-sm-6">
                                                   ...
                                                   <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                         <label class="col-sm-4 control-label">Product Group Name (Nama Grup Produk)</label>
                                                         <div class="col-sm-6">
                                            ...
                                            <div class="container">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                      Product Group Code(Kode Grup Produk)
                                                    <input type="text" class="form-control" id="kode" name="kode" placeholder="Product Group Code">
                                                  </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-sm-6">
                                                        Product Group Name(Nama Grup Produk)
                                                      <input type="text" class="form-control" id="nama" name="nama" placeholder="Product Group Name">
                                                    </div>
                                                    </div>
                                                    <!-- <div class="form-group">
