...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Sub Group Prduk</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Sub Group Produk</h1>
            ...
            <div class="col-sm-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Sub Grup Produk</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                  ...
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-master-subgrupdtl.php">
                      ...
                      <div class="form-group">
                          <label class="col-sm-10 control-label">Kode Master Group</label>
                          <div class="col-sm-2">
                            <select name="kodemastergrup" id="kodemastergrup">
                        ...
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Kode Sub Group</label>
                            <div class="col-sm-2">
                          ...
                          <div class="form-group">
                              <label class="col-sm-6 control-label">Nama Sub Grup</label>
                              <div class="col-sm-6">
