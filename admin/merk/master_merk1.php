...
?>
      ...
      <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Brand <a href="master_merk.php" class="btn btn-primary btn btn-sm" role="button"><i class="fa fa-plus"></i></a></h1>
        ...
        <tbody>
          ...
          <tr class="odd gradeX">
            ...
            <td class="with-btn" nowrap="">
              ...
              <a href="master_merk.php?aksi=view&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-pencil-alt"></i></a>
              <!-- <a href="#" class="btn btn-primary" role="button"><i class="fa fa-pencil-alt"></i></a> -->

                <a href="proses-merk.php?aksi=update&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-minus"></i></a>
                <a href="proses-merk.php?aksi=active&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-check"></i></a>
              <a href="proses-merk.php?aksi=delete&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn btn-xs" role="button"><i class="fa fa-trash"></i></a>
                          ...
                          <div class="panel-body panel-form">
                            <div class="container">
                              <div class="form-group">
                               ...
                               <div>
                       <div class="form-group">
                         <label class="col-sm-10 control-label">Brand Code</label>
                         <div class="col-sm-2">
                           <input type="text" class="form-control" id="kode" value="<?php echo $kodep; ?>" name="kode">
                        </div>
                        <div>
                        <div class="form-group">
                          <label class="col-sm-6 control-label">Brand Name</label>
                        <div class="col-sm-6">
                    ...
                    <button type="submit" name="daftar1" value="daftar1" class="btn btn-default">Update</button>
                      <?php } else { ?>
                        ...
                        <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                          <!-- begin panel-heading -->
                          <div class="panel-heading">
                            <h4 class="panel-title">Add New Brand</h4>
                          </div>
                          <!-- end panel-heading -->
                          <!-- begin panel-body -->
                          <div class="panel-body panel-form">
