...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Negara Supplier</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Negara Supplier</h1>
            ...
            <div class="col-sm-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Negara Supplier</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body panel-form">
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-negara.php">
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Kode Negara</label>
                            <div class="col-sm-2">
                          ...
                          <div class="form-group">
                              <label class="col-sm-6 control-label">Nama Negara</label>
                              <div class="col-sm-6">
