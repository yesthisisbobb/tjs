                                      ...
                                      <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                          ...
                                          <td class="with-btn" nowrap="">
                                            ...
                                            <a href="master_pattern.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
                                  ...
                                  <div class="col-lg-12 col-12 mx-auto">
                                    <form class="form-horizontal" method="post" action="proses-master-grup.php">
                                      ...
                                      if ($aksi=="view")
                                      {
                                       ...
                                       <div class="form-group">
                                         <label class="col-sm-10 control-label">Pattern Code (Kode Pola)</label>
                                         <div class="col-sm-6">
                                        ...
                                        <div>
                                        <div class="form-group">
                                          <label class="col-sm-6 control-label">Pattern Name (Nama Pola)</label>
                                        <div class="col-sm-6">
