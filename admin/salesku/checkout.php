...
while($row = mysqli_fetch_array($query2)) {
		...
		// $tgl=$row['tgl'];
			$tgl=date("d/m/y");
			$noso="SO"."/"."$tgl"."/"."SBY"."/".$noakhir1;
		$sql1 = "INSERT INTO jual(tgl,cart_id,noso,sess_id,user_id,status_payment)  VALUES ('$tgl','$noakhir1','$noso','$sesi','$uid','Unpaid')";
...
?>
	...
	<a href="index-shop.php?status=sukses" class="close" data-dismiss="alert" aria-label="close">&times;</a>
