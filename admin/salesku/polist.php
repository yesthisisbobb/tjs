...
function ambildata(str2)
{
  ...
  objekxhr.open("GET", "TampilMhs4.php?q="+str2,true);
  objekxhr.send(null);
                                    ...
                                    <table id="zero-config" class="table table-hover" style="width:100%">
                                      <thead>
                                        <tr>
                                          ...
                                          <th class="text-nowrap">SO Indent.Date</th>
                                          <th class="text-wrap">SO Indent No.</th>
                                      ...
                                      <tbody>
                                        ...
                                        <?php
                                          ...
                                          ?>
                                          <?php
                                            $sqlin3 = "SELECT * FROM po where noso='$nosoku'";
                                        ...
                                        <tr class="odd gradeX">
                                          ...
                                          <td class="with-btn" nowrap="">
                                            ...
                                            <!-- <a href="editquote.php?id=<?php echo $amku["cart_id"];?>&no=<?php echo $amku["no"]; ?>" class="btn-primary btn-rounded btn-sm" role="button">View</a></h1> -->
                                              ...
                                              <a href="viewpo.php?noso=<?php echo $nosoku; ?>&id=<?php echo $amku["cart_id"];?>" class="btn btn-info btn-rounded btn-sm" role="button">PO Confirmation</a></h1>
                                              <button class="btn btn-rounded btn-sm btn-info" id="tom" name="tom" onclick="ambildata('<?php echo $amku["noso"]; ?>')">Purchase Order(<?php echo $cekin3; ?>)</button>
