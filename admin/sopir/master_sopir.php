...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data sopir</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Sopir</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Sopir</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body panel-form">
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-sopir.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-8 control-label">No.Truk</label>
                                        <div class="col-sm-4">
                                          <select class="form-control" id="notruk" name="notruk">
                                            <option>Jenis Truk</option>
                                        				<?php
                                        					$sql = "SELECT * FROM truk";
                                               				 $query = mysqli_query($conn, $sql);
                                                			 while($amku = mysqli_fetch_array($query)){
                                        							echo '<option>'.$amku['nopol'].'</option>';
                                        						}
                                        					?>
                                            </select>
                                      </div>
