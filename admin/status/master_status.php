...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Status Transportasi</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Status Transportasi</h1>
            ...
            <div class="col-sm-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Status Transportasi</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body panel-form">
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-status.php">
