            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Tipe</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body panel-form">
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-tipe.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Kode Tipe</label>
                            <div class="col-sm-2">
                          ...
                          <div class="form-group">
                              <label class="col-sm-6 control-label">Nama Tipe</label>
                              <div class="col-sm-6">
