...
if(isset( $_POST['daftar']))
	{
	    ...
	    $sql = "INSERT INTO master_tipe (kodegrup,kode, nama, import, panjang, lebar,faces, surface,
				color, pattern, buy, stock, selling, ll, bc, bc1, material, nts, min, max, smallamount, nm_user, kon, status)VALUES
				('$kodegrup', '$kode', '$nama', '$import', '$panjang', '$lebar', '$faces', '$surface','$color','$pattern',
