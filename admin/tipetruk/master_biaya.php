...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Biaya Kirim</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Biaya Kirim</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Biaya Kirim</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body panel-form">
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-biaya.php">

                          <div class="form-group">
                              <label class="col-sm-8 control-label">Tipe Transportasi</label>
                              <div class="col-sm-4">
                                <select class="form-control" id="tipe" name="tipe">
                                  <option>Tipe Transportasi</option>
                                      <?php
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-6 control-label">Biaya</label>
                                    <div class="col-sm-6">
