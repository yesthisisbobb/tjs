...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Tipe Truk</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Tipe Truk</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Tipe Truk</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                  ...
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-tipe.php">
                          ...
                          <div class="form-group">
                              <label class="col-sm-6 control-label">Tipe Truk</label>
                              <div class="col-sm-6">
