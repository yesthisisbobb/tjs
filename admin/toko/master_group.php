...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Grouping</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Grouping</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Grouping</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                  ...
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-cabang.php">
                      <div class="form-group">
                          <label class="col-sm-6 control-label">Nama Group</label>
                          <div class="col-sm-6">
                          <input type="text" class="form-control" id="nm_grup" name="nm_grup">
                        </div>
                        </div>
                          <div class="form-group">
                              <label class="col-sm-6 control-label">Nama Toko utk Grouping</label>
                              <div class="col-sm-6">
                                <select class="form-control" id="customer" name="customer">
                                  <option>Master Toko</option>
                                      <?php
                                        $sql = "SELECT * FROM detail_toko";
                                             $query = mysqli_query($conn, $sql);
                                             while($amku = mysqli_fetch_array($query)){
                                            echo '<option>'.$amku['nama_toko'].'</option>';
                                          }
                                        ?>
                                  </select>
                            </div>
