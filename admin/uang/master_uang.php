            ...
            <div class="col-sm-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Currency</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body panel-form">
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-uang.php">
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Mata Uang</label>
                            <div class="col-sm-2">
