                                      ...
                                      <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                          ...
                                          <td class="with-btn" nowrap="">
                                            ...
                                            <a href="master_unit.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
