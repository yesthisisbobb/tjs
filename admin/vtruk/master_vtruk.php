...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Data Virtual Transport</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Data Virtual transport</h1>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-heading">
                  <h4 class="panel-title">Master Virtual Transport</h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                  ...
                  <div class="container">
                    <form class="form-horizontal" method="post" action="proses-vtruk.php">
                        <div class="form-group">
                            <label class="col-sm-10 control-label">Tipe Truk</label>
                            <div class="col-sm-2">
                              <select class="form-control" id="nopol" name="nopol">
                                <option>Tipe Truk</option>
                            				<?php
