...
?>
      ...
      <div id="content" class="content">
        ...
        <ol class="breadcrumb pull-right">
          ...
          <li class="breadcrumb-item active">Master Virtual Truck</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Master Virtual Truck <a href="master_merk.php" class="btn btn-primary btn btn-sm" role="button"><i class="fa fa-plus"></i></a></h1>
      ...
      <table id="data-table-buttons" class="table table-striped table-bordered">
        <thead>
          <tr>
            ...
            <th class="text-nowrap">Type</th>
              <th class="text-nowrap">Max Vol</th>
              <th class="text-nowrap">Max Tonnage</th>
        ...
        <tbody>
          ...
          <?php
            $sql = "SELECT * FROM master_vtruk ORDER BY no";
          ...
          <tr class="odd gradeX">
            ...
            <td class="with-btn" nowrap="">
              ...
              <a href="master_merk.php?aksi=view&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn btn-sm" role="button"><i class="fa fa-pencil-alt"></i></a>
      ...
      <div id="add_show">
          <div class="row">
            <div class="col-lg-12">
                    <form class="form-horizontal" method="post" action="proses-vtruk.php">
                      <?php
                      $aksi=$_GET['aksi'];
                      if ($aksi=="view")
                      {
                        ...
                        <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                          ...
                          <div class="panel-heading">
                            <h4 class="panel-title">View/Update Brand</h4>
                          </div>
                          <!-- end panel-heading -->
                          <!-- begin panel-body -->
                          <div class="panel-body panel-form">
                            <div class="container">
                              <div class="form-group">
                               ...
                               <div>
                       <div class="form-group">
                         <label class="col-sm-10 control-label">No.Pol</label>
                         <div class="col-sm-2">
                    ...
                    <button type="submit" name="daftar1" value="daftar1" class="btn btn-default">Update</button>
                      <?php } else { ?>
                        ...
                        <div class="panel panel-primary" data-sortable-id="form-plugins-1">
                          <!-- begin panel-heading -->
                          <div class="panel-heading">
                            <h4 class="panel-title">Add New Virtual Truck</h4>
                          </div>
                          <!-- end panel-heading -->
                          <!-- begin panel-body -->
                          <div class="panel-body panel-form">
                            <div class="container">
                              ...
                              <div class="form-group">
                                <label class="col-sm-8 control-label">No.Pol</label>
                                <div class="col-sm-4">
                                  <input type="text" class="form-control" id="kode" value="<?php echo $kodep; ?>" name="kode">
                               </div>
                               <div>
                                 <div class="form-group">
                                     <label class="col-sm-8 control-label">Type</label>
                                     <div class="col-sm-4">
                                       <select class="form-control" id="jenis" name="jenis">
                                         <option>Single</option>
                                         <option>Double</option>
                                   ...
                                   <div class="form-group">
                                     <label class="col-sm-8 control-label">Max Vol(m3)</label>
                                     <div class="col-sm-2">
                                       <input type="text" class="form-control" id="vol"  name="vol">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="col-sm-8 control-label">Max Tonnage(ton)</label>
                                    <div class="col-sm-2">
                                      <input type="text" class="form-control" id="sqm"  name="sqm">
                                   </div>
                                 </div>
                                 <div class="form-group">
                                     <label class="col-sm-8 control-label">Driver</label>
                                     <div class="col-sm-4">
                                       <select class="form-control" id="sopir" name="sopir">
                                         <option>Supriyono</option>
                                         <option>Jamal</option>
                                         <option>Jamil</option>
                                     </select>
                                   </div>
