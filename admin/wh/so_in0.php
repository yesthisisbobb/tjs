...
<!-- showmodal -->
              ...
              <?php echo "<a href='#myModal' class='btn btn-default btn-small' id='noku' data-toggle='modal' data-id=".$noku.">Detail</a>"; ?>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function(){
                            $('#myModal').on('show.bs.modal', function (e) {
                                var rowid = $(e.relatedTarget).data('noku');
...
<!-- end of modal -->
              ...
              <a href="so_in.php?aksi=view&cartid=<?php echo $amku["cart_id"]; ?>&no=<?php echo $amku["no"]; ?>" class="btn btn-primary btn btn-sm" role="button"><i class="fa fa-pencil-alt"></i></a>
