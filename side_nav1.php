...
<head>
  ...
  <title>
    Tjandra System-Administrator Module
  </title>
  ...
  <!-- CSS Files -->
  <link href="../material_dashboard/assets/css/material-dashboard.css?v=2.0.2" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="../material_dashboard/assets/demo/demo.css" rel="stylesheet" />
</head>

<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="../material_dashboard/assets/img/sidebar-1.jpg">
      <!--
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <div class="user">
          <div class="photo">
            <img src="../material_dashboard/assets/img/faces/avatar.jpg" />
          </div>
          <div class="user-info">
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            <!-- <a class="nav-link" data-toggle="collapse" href="#pagesExamples">
              ...
              <p>Tour<b class="caret"></b>
              </p>
            </a> -->
              <a data-toggle="collapse" href="#pagesExamples" class="nav-link">
              <i class="material-icons">image</i>
              <span>
                TOUR
                <!-- <b class="caret"></b> -->
            ...
            <div class="collapse" id="pagesExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/user.html">
                    <span class="sidebar-normal"> Add New User </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/role.html">
                    <span class="sidebar-normal"> Add New Role </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/cur.html">
                    <span class="sidebar-normal"> Add New Currency </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/tt.html">
                    <span class="sidebar-normal"> Add New Tour Type </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/tf.html">
                    <span class="sidebar-normal"> Add New Tour Feature </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/provinsi.html">
                    <span class="sidebar-normal"> Add New Province </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/country.html">
                    <span class="sidebar-normal"> Add New Country </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/tour.html">
                    <span class="sidebar-normal"> Add New Tour </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/galeri.html">
                    <span class="sidebar-normal"> Add New Tour Image </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="../examples/forms/itt.html">
                    <span class="sidebar-normal"> Add New Tour Ittineray </span>
                  </a>
                </li>
