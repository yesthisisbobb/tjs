...
while($row = mysqli_fetch_array($query2)) {
		...
		$sql1 = "INSERT INTO jualq(cart_id,sess_id,proyekid,user_id,tgl,sales,status_payment)  VALUES ('$id','$sesi','$kodepp','$uid','$tgl','$salesnya','Unpaid')";
	...
	while($row1 = mysqli_fetch_array($query3)) {
			...
			$sql5 = "INSERT INTO jualdtlq(no_cart,sess_id,kode_stok,shading,jumlah,harga,total)  VALUES ('$id','$sesi','$kodestok','$shading','$jumlah','$harga','$total')";
			$query5 = mysqli_query($conn, $sql5);
			$sql51 = "INSERT INTO ordertempq(no_cart,sess_id,kode_stok,shading,jumlah,harga,total)  VALUES ('$id','$sesi','$kodestok','$shading','$jumlah','$harga','$total')";
			$query51 = mysqli_query($conn, $sql51);

			$sql6 = "UPDATE jualq set total='$gt',grand_total='$gt' where cart_id='$id'";
