...
.button1 {background-color: #e7e7e7; color: gray; font-family:"roboto";
box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);width:50%;}
        ...
        <div class="main-header-wrap">
            <div class="container ml-0">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-10 mt-25 ml-100 mr-0 ">
...
?>
                    ...
                    <div class="col-xl-4 col-xl-5">
                        <div class="header-right-wrap mt-35 pt-0 mr-0 ml-0 pl-0 pr-0">

                            <?php
                            $sql1212 = "SELECT * FROM cart";
                                 $query1212 = mysqli_query($conn, $sql1212);
                                 while($am1212 = mysqli_fetch_array($query1212)){
                                   $kodep=$am1212['kodep'];
                                 }
                            $s=session_id();
                            $namauser=$_SESSION["username"];
                            $b=1;
                            $sqlcart = "SELECT * FROM jualq where proyekid='$kodep'";
...
<?php
            $nama3=$_SESSION["username"];
                                      $sql12 = "SELECT * FROM login where username='$nama3'";
                                           $query12 = mysqli_query($conn, $sql12);
                                           while($am12 = mysqli_fetch_array($query12)){
                                             $divisi12=$am12['divisi2'];
                                           }
                                    if ($divisi12=="PTA LOW")
                                    {
                                      $r1=session_id();
                                      $sql121 = "SELECT * FROM cart where sess_id='$r1'";
                                           $query121 = mysqli_query($conn, $sql121);
                                           while($am121 = mysqli_fetch_array($query121)){
                                             $kodep=$am121['kodep'];
                                           }
                                      ?>
                                        <input type="HIDDEN" value="P" id="jenis" name="jenis">

                                        <?php
                                        // $un=$_SESSION["id"];
                                        $tgl= date("d/m");
                                        $ss="Q/".$kodep."/"."$tgl"."/".$b;
                                         ?><b>Quotation No.<?php echo $ss; ?></b>
                                      ...
                                      <?php
                                        ...
                                        <h4>SHOPPING CART</h4>
                                        <input type="hidden" value="NP" id="jenis" name="jenis">
                                        <span><?php
                                        $un=$_SESSION["id"];
                                        $tgl= date("d/m");
                                        $ss="SO/".$un."/"."$tgl"."/".$b;
                                    ...
                                    <div class="shopping-cart-bottom">
                                        ...
                                        <div class="shopping-cart-btn btn-hover text-center">
                                          <?php
                                          $namaku22=$_SESSION["username"];
                                          $sqlku22 = "SELECT * FROM login where username='$namaku22'";
                                               $queryku22 = mysqli_query($conn, $sqlku22);
                                               while($amku22 = mysqli_fetch_array($queryku22)){
                                                  $divisiku22=$amku22['divisi2'];
                                                }
                                                if ($divisiku22=="PTA LOW")
                                                {
                                                 ?>
                                                   <a class="default-btn" href="checkout1.php?sesi=<?php echo $r; ?>&id=<?php echo $ss; ?>&kodep=<?php echo $kodep; ?>">Save Quotation</a>
                                               <?php } else {?>
                                          ...
                                          <?php }?>
                                            ...
                                            <input type="hidden" name="sesi" id="sesi" value="<?php echo $ss; ?>">
                                        </div>
                                    </div>
                            ...
                            <form class="form-inline" action="index.php" method="GET">
                              <div class="form-group ml-10 ">
                                <input type="text" class="form-control input-sm" size="25" placeholder="Type To Search" name="cari">
                            ...
                            <div class="setting-wrap">
                                <button class="setting-active">
                                  ...
                                  <?php }
                                    ...
                                    <img  class="rounded-circle mt-0 ml-0"  width="50" height="50" alt="" src="assets/img/bg/<?php echo $gam; ?>">
                                ...
                                <div class="setting-content">
                                    ...
                                    <?php } else {
                                      ...
                                      $c1=0;
                                      $nama1=$_SESSION["username"];
                                      $sqlb1 = "SELECT * FROM jualq where user_id='$nama1'";
                                           $queryb1 = mysqli_query($conn, $sqlb1);
                                           while($amb1 = mysqli_fetch_array($queryb1)){
                                             $c1=$c1+1;
                                           }
                                      ?>
                                      <?php
                                      ...
                                      <div cols="col-sm-8">
                                        <h6 style="color:blue"><?php echo strtoupper($namanya); ?></h6>
                                        <p style="color:blue" class="small"><?php echo $divisi1; ?>


                                      </div>
                                      </div>
                                      <?php
                                      $sql11 = "SELECT * FROM login where username='$nama2'";
                                           $query11 = mysqli_query($conn, $sql11);
                                           while($am11 = mysqli_fetch_array($query11)){
                                             $divisi11=$am11['divisi2'];
                                           }
                                      ?>
                                      <hr>
                                        <li style="font-family:roboto;"><i class="fa fa-user" style="font-size:16px;color: #17A589;"></i><a href=""> User Profile</a></li>
                                        <?php if ($divisi11=="PTA LOW")
                                        {
                                        ?>
                                        <li style="font-family:roboto;"><i class="fa fa-receipt" style="font-size:16px;color: #17A589;"></i><a href="projectlist.php"> Project List</a><span class="badge badge-info"><?php echo $c1; ?></span></li>
                                          <li style="font-family:roboto;"><i class="fa fa-receipt" style="font-size:16px;color: #17A589;"></i><a href="quotelist.php"> Quotation List</a><span class="badge badge-info"><?php echo $c1; ?></span></li>

                                        <?php } ?>
                                        <li style="font-family:roboto;"><i class="fa fa-receipt" style="font-size:16px;color: #17A589;"></i><a href="invlist.php"> Invoice List</a><span class="badge badge-info"><?php echo $c; ?></span></li>
                                        <!-- <li style="font-family:roboto;"><i class="fa fa-bookmark" style="font-size:16px;color: #17A589;"></i><a href="favlist.php"> Favorite Item</a><span class="badge badge-info"><?php echo $e; ?></span></li> -->
                                        <hr mt-0>
...
<div class="container-fluid pt-0 pr-0 pl-0 pb-0 mr-0 ml-0 bg-default">
  <img src="assets/img/logo/25.png" width="100%">
</div>
    <div class="breadcrumb-area pt-0 pb-0 bg-white">
      <img src="assets/img/bg/GP BRAVAT.jpg" width="100%">
      <div class="centered3"><h1 style="font-size:34";"font-family:verdana";>We always Provide The Best Quality and Services</h1>
        <hr class="new1">
        <a href="#c4" class="btn btn-default btn-lg button1" role="button">Check Our Product</a></div>
    ...
    <div class="container-fluid pt-0 pr-0 pl-0 pb-0 mr-0 ml-0 bg-info">
      <div class="row">
  <div class="col-sm-4 pt-0 pr-0 pl-0 pb-0 mr-0 ml-0 mt-0 mb-0">
    <img src="assets/img/bg/11.png" height="100%" width=100%>
    <div class="kanan"><h2>Sanitary Promo</h2></div> -->
     <div class="kanan2">
    <button class="button btn-transparent btn-default"> See more </button></div>
</div>
<div class="col-sm-4 pt-0 pr-0 pl-0 pb-0 mr-0 ml-0">
<img src="assets/img/bg/12.png" height="100%" width="100%">
<div class="kanan"><h2>Granite Promo</h2></div>
<div class="kanan2"><button class="button btn-transparent btn-default"> See more </button></div>
</div>
<div class="col-sm-4 pt-0 pr-0 pl-0 pb-0 mr-0 ml-0 ">
  <img src="assets/img/bg/13.png" height= 100% width="100%">
                ...
                <div class="col-lg-12">
                    <div class="shop-top-bar">
                        <div class="select-shoing-wrap">
                            ...
                            $adjacents=2;
                            ?><p> Showing Page <?php echo $halskrg; ?>1 of Total <?php echo $pagecount; ?> pages</p>
                            <?php
                            if (!isset($_GET["page"])){
                              $activepage=1;
                                                    ...
                                                    <div class="ht-product-content-inner">
                                                      ...
                                                      <?php } ?>
                                                        ...
                                                        <h4 class="ht-product-title"><a href="product-details.php?kode=<?php echo $kodetjs; ?>"><?php echo $kodetjs; ?></a>
                                                          <img src="assets/img/fav/fav1.png">

                                                          <hr>
                                                        <h6 class="ht-product-subtitle text-muted"><?php echo $namasup; ?>
                                                        <!-- <?php
                                                        ...
                                                        ?>
                                                          ...
                                                          $sql2 = "SELECT * FROM master_price where kode='$kodetjs' and divisi='$divisi1' and status='Active'";
                                                               ...
                                                               if ($grupku=='promo')
                                                               {
                                                                 ...
                                                                 ?>
                                                                 <span class="badge badge-success"><?php echo $promo; ?> % Off</span>
                                                                 <?php
                                                               }
                                                                ?>
                                                               ...
                                                               <span class="badge badge-danger">Indent Stock</span>
                                                               <?php
                                                               }
                                                               ...
                                                               <?php
                                                                 ...
                                                                 <span class="badge  badge-warning">Limited Stock </span>
                                                               <?php } else if ($jum>18) { ?>
                                                               <h6 class="ht-product-subtitle"><span class="badge  badge-info">Ready Stock</span></h6>
                                                               <?php }
                                                               }
