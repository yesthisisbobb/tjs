...
str3=document.getElementById("harga").value;
objekxhr.open("GET", "TampilMhs.php?w="+str3+"&y="+str2+"&q="+str,true);
objekxhr.send(null);
         ...
         while($amku = mysqli_fetch_array($query)){
           ...
           $flag=$_GET['flag'];
            ...
            $jumss=0;
              if($divisi11=="PTA LOW")
              {
              $sqlss = "SELECT * FROM master_shading where kode_stok='$kodestok' and (katgd='DISTRIBUSI' or katgd='RETAIL')";
              }
                      ...
                      <?php } ?>
                        ...
                        <span> 3. Contact Our Administration if you do not want to split order or use another shading and choose to indent total of your requirement quantity </span><br><hr> -->
                          ...
                          <form class="form-horizontal" method="post" action="">
                            ...
                            ?>
                            <input type="hidden"  name="harga" id="harga" value="<?php echo $pldosdis; ?>">
                          <?php } else { ?>
                            <input type="hidden"  name="harga" id="harga" value="<?php echo $pldosdis; ?>">
                          <?php } ?>
                        ...
                        <div class="pro-details-quality">
                          <table border="1" width="35%">
                                  ...
                                  <tr>
                                    ...
                                    <td align="center"><h2><?php echo $jum ?></h2></td>
                                  </tr>
                                  <tr>
                                    <td align="center">
                                      Carton
