...
$nomer=$_GET['no'];
 ...
 $sql12 = "SELECT * FROM customer where username='$un12'";
  ...
  ?>
 <?php
     $sql11 = "SELECT * FROM jualq where cart_id='$nomer'";
   ...
   ?>
            <div class="container pl-20 ml-30 mt-10">
                <div class="row">
                    ...
                    <div class="border col-xl-4">
                        <div class="logo pt-2">
                          <h4>QUOTATION</h4><H6>(Ready Stock)</H6><hr>
                          <p>No.  : <?php echo $nomer; ?>
                          <br>Date  : <?php echo $tanggal; ?>
                          <!-- <br>No. FJ  : -
                          <br>Tgl.FJ  : - </p> -->
...
<tbody align="center">
  ...
  <?php
  $no=0;
      $sql = "SELECT * FROM jualdtlq where no_cart='$nomer'";
...
<?php
    $sql1 = "SELECT * FROM jualq where cart_id='$nomer'";
       $query1 = mysqli_query($conn, $sql1);
       while($amku1 = mysqli_fetch_array($query1)){
          $totalku=$amku1['total'];
          $disku=$amku1['dis'];
