...
while($row = mysqli_fetch_array($query2)) {
		...
		$sql1 = "INSERT INTO jual(tgl,cart_id,noso,sess_id,user_id,sales,status,status_payment)  VALUES ('$tgl','$noakhir1','$noso','$sesi','$uid','$sales','OPEN','Unpaid')";
		$query1 = mysqli_query($conn, $sql1);
	}

	$sql3 = "SELECT * from cartdtl where sess_id='$sesi'";
	...
	while($row1 = mysqli_fetch_array($query3)) {
			...
			$sql5 = "INSERT INTO jualdtl(no_cart,noso,sess_id,kode_stok,jumlah,harga,total)  VALUES ('$noakhir1','$noso','$sesi','$kodestok','$jumlah','$harga','$total')";
...
?>
		...
		if( $query8 )
			{
				header('Location: index-shop.php?status=selesai');


	// <!-- <div class="container-fluid text-center pt-100 pb-100">
	// <div class="alert alert-info alert-dismissible">
	// <a href="index-shop.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	// <strong>Thank You for order, </strong>  Please Procceed to Cashier if you are done,<br>
	// if you want to check you order again just <a href="index-shop.php#produk" class="btn btn-info" role="button">Click Here</a>
	// </div>
	// </div> -->
