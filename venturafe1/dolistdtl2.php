...
$nomer=$_GET['no'];
 ...
 $sql12 = "SELECT * FROM customer where username='$un12'";
  ...
  ?>
 <?php
     $sql11 = "SELECT * FROM do where noinv='$nomer'";
   ...
   ?>
            <div class="container pl-20 ml-30 mt-10">
                <div class="row">
                    ...
                    <div class="border col-xl-3">
                        <div class="logo pt-2">
                          <h3>DO</h3><p class="small">No.<?php echo $nodo; ?></p><hr>

                          <b>DO.Date : </b><?php echo $tanggal; ?><BR>
...
<tbody align="center">
  ...
  $no=0;
  $totalg=0;
      $sql = "SELECT * FROM dodtl where noinv='$nomer'";
...
<td></td><td></td><td></td><td></td><td></td><td>Total</td><td><?php echo rupiah($totalg); ?></td>
...
<td></td><td></td>  <td></td><td></td><td></td><td></td><td></td><td></td><td>Disc</td><td><?php echo rupiah($disku); ?></td>
  <?php } ?>
  </tr>
  <tr align="center">
  <td></td><td></td><td></td><td></td><td></td><td>Packing Cost</td><td><?php echo rupiah("0"); ?></td>
  </tr>
  <tr align="center">
<td></td><td></td><td></td><td></td><td></td><td>Delivery Cost</td><td><?php echo rupiah("0"); ?></td>
  </tr>
  <tr align="center">
  <td></td><td></td><td></td><td></td><td></td><td>Grand Total</td><td><?php echo rupiah($gtku); ?></td>
  </tr>
  <tr align="center">
    <td></td><td></td><td></td><td></td><td></td><td>Paid</td><td><?php echo rupiah($bayarku); ?></td>
    </tr>
    <!-- <tr>
      <?php
      ...
      <div class=" col-xl-6">
        ...
        <div class="col-xl-1.75">
            <div class="logo pt-40 ml-40 mr-15">
              ...
              SIGN HERE
                <p><br><b><?php echo "Mr.Budi Raharjo"; ?></b></p>
                <P><button class="btn btn-info btn-sm">Click to receive</button>
