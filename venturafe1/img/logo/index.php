...
<a name="c4"></a>
   ...
   $sql = "SELECT * FROM master_stok where kodeitem_stok like '%".$cari."%'";
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                      ...
                                                      $sql2 = "SELECT * FROM master_hpp where tjscode='$kodetjs' and status='Active'";
                                                        ...
                                                        <h4 class="ht-product-title"><a href="product-details.php?kode=<?php echo $kodetjs; ?>"><?php echo $kode; ?></a>
                                                        ...
                                                        $namauser=$_SESSION["username"];
                                                            ...
                                                            $queryaktif = mysqli_query($conn, $sqlaktif);
                                                             ...
                                                             { ?>
                                                                ...
                                                                <a href="fav.php?status=del1&kode=<?php echo $kodetjs; ?>"> <i class="fa fa-bookmark" style="font-size:16px;color: #17A589;"></a></i>
                                                             <?php } else { ?>
                                                        <a href="fav.php?kode=<?php echo $kodetjs; ?>"><i class="fa fa-bookmark-o" style="font-size:16px;color: black;"></i></a></h4>
                                                      <?php }?>
                                                        ...
                                                        {
                                                          echo "<i class='fa fa-thumbs-up' style='font-size:20px;color: green;'></i>";
                                                      ...
                                                      $ab=0;
                                                        ...
                                                        <div class=ht-product-price>
                                                          ...
                                                          <span class="disc">You</span><span class="biasa">  Save</span><span class="biasa2"><?php echo $diskon."%"; ?></span>
                                                        <?php } else if (($ab>0) && ($grupku==''))
                                                      {
                                                        ?>
                                                          <span class="disc">You</span><span class="biasa">  Save</span><span class="biasa2"><?php echo $diskon."% + ".$promo1."%"; ?></span>
