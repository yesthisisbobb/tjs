				...
				<div class="container clearfix">
					...
					<div class="tabs topmargin-lg clearfix" id="tab-3">
						...
						<ul class="tab-nav clearfix">
							...
							<li><a href="#tabs-11">Favourite</a></li>
							<li><a href="#tabs-11">Promo Item</a></li>
							<li><a href="#tabs-11">Promo Package</a></li>
						</ul>
									...
									<div class="product col-lg-2 col-md-4 col-sm-6 col-12">
										...
										<div class="grid-inner">
											...
											<div class="product-desc">
												...
												<div class="product-price text-muted"><?php echo rupiah($cogskut); ?></div>
												<?php
												if($jum==0)
												{
												?>
