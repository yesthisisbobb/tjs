										...
										<div class="top-cart-item">
											...
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
													...
													<span class="top-cart-item-price d-block"><?php echo $har; ?></span>
												</div>
				...
				<div class="container clearfix">
					...
					<div class="tabs topmargin-lg clearfix" id="tab-3">
						...
						<ul class="tab-nav clearfix">
							...
							<li><a href="#tabs-11">My Favourites</a></li>
<li><a href="#tabs-10">Best sellers</a></li>
							<li><a href="#tabs-11">Promo Items</a></li>
							<li><a href="#tabs-11">Promo Packages</a></li>
						</ul>
						...
						<div class="tab-container">
							...
							<div class="tab-content" id="tabs-9">
								...
								<div class="shop row gutter-30">
									<?php
									$sql = "SELECT * FROM master_stok where status='Active'";
									...
									<div class="product col-lg-2 col-md-4 col-sm-6 col-12">
										...
										<div class="grid-inner">
											...
											<div class="product-image">
												...
												<!-- <a href="#"><img src="img/gambar/<?php echo $kodetipe;?>.jpg"></a> -->
											...
											<div class="product-desc">
												<a href="proses-cart3.php?kode=<?php echo $kodetjs; ?>" class="btn btn-light btn-sm mt-5 ml-3 mr-1"><i class="icon-shopping-basket"></i></a>
													<a href="#" class="btn btn-light btn-sm mt-5 ml-2 mr-1"><i class="icon-thumbs-up"></i></a>
												...
												<hr>
												<div class="product-title1">	<a href="include/ajax/shop-item.php?kode=<?php echo $kodetjs; ?>" data-lightbox="ajax"><h3><?php echo $kodetipe; ?></h3></a></div>
												<div class="product-merk text-muted"><?php echo $namasup; ?></div>
												<div class="product-merk text-muted"><?php echo $grup; ?></div>
												<div class="product-price text-muted"><?php echo rupiah($pl); ?></div>
												<?php
												if($jum==0)
												{
												?>
								...
								<div class="shop row gutter-30">
									...
									<div class="product col-lg-2 col-md-4 col-sm-6 col-12">
										...
										<div class="grid-inner">
											...
											<div class="product-image">
												<a href="include/ajax/shop-item.php?kode=<?php echo $kodetjs; ?>" data-lightbox="ajax"><img src="img/gambar/<?php echo $kodetipe;?>.jpg" alt="Checked Short Dress"></a>
											  <a href="include/ajax/shop-item.php?kode=<?php echo $kodetjs; ?>" data-lightbox="ajax"><img src="img/gambar/<?php echo $kodetipe;?>.jpg" alt="Checked Short Dress"></a>
												<!-- <a href="#"><img src="images/shop/dress/1-1.jpg" alt="Checked Short Dress"></a> -->
												<!-- <div class="sale-flash badge badge-success p-1">50% Off*</div> -->
												<div class="bg-overlay">
