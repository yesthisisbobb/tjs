...
<body class="stretched">
    ...
    <p id="hiddenlater">A High Standard Quality of Tile & Sanitary</p>
		<a href="#produkoke" id="hiddenlater" class="btn btn-info" role="button">Our Products</a>
  </div>
			</div>
<br><br>
<div class="container">
					...
					<div class="tabs topmargin-lg clearfix" id="tab-3">
								...
								$queryuku = mysqli_query($conn, $sqluku);
									 while($amkuuku = mysqli_fetch_array($queryuku)){
										 $totu=$totu+1;
										 	...
										 	?>
							<li><a href="#tabs-10">My Favourites <span class="badge badge-pill badge-warning"><?php echo $totu;?></span></a></li>
						...
						<div class="tab-container">
							<div class="tab-content" id="tabs-9">
									...
									if ($nama=="")
									{
									$sqlaa = "SELECT * FROM master_stok where status='Active'";
									}
									else {
										$sqlaa = "SELECT * FROM master_stok where grupname='$nama' and status='active' order by no desc limit $posisi,$batas";
									}
									$queryaa = mysqli_query($conn, $sqlaa);
											 while($amku = mysqli_fetch_array($queryaa)){
...
<?php } $no++; } ?>
							...
							<div class="tab-content" id="tabs-10">
								...
								<div class="shop row gutter-30">
									...
									$sqlfav = "SELECT * FROM fav where user='$useridku'";
										...
										<div class="grid-inner">
											...
											$sql2 = "SELECT * FROM master_price where kode='$kodetjs'";
													 ...
													 $queryss = mysqli_query($conn, $sqlss);
													  ...
													  ?>
											<div class="product-desc">
												<a href="proses-cart3.php?kode=<?php echo $kodetjs; ?>" class="btn btn-light btn-sm mt-5 ml-3 mr-1"><i class="fa fa-shopping-basket"></i></a>
												<?php
												$ada=0;
												$unku1=$_SESSION["username"];
												$sqlku1 = "SELECT * FROM fav where kode='$kodetjs' and user='$unku1'";
