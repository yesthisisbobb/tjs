...
$nomer=$_GET['no'];
 ...
 <?php
   ...
   ?>
   <?php
       $sql111 = "SELECT * FROM login where email='$sales'";
     ...
     ?>
            <div class="container pl-20 ml-30 mt-10">
                <div class="row">
                    ...
                    <div class="border col-xl-3">
                        <div class="logo pt-2">
                          <h3>INVOICE</h3><p class="small"><?php echo $nomer; ?></p><hr>

                          <b>INV.Date : </b><?php echo $tanggal; ?><BR>
                          <b>Delivery Date : </b><?php echo $tanggal; ?><BR>
                    ...
                    <div class="border col-xl-3">
                        <div class="logo pt-2">
                          <h3>CUSTOMER</h3>
                          <h6><b><?php echo strtoupper($cust); ?></b></h6><hr>
                          <b>Mr.Budi Raharjo</b><br>
                          <?php echo $alamat12; ?>
                        ...
                        <div class="logo pt-0 mt-0 mb-2">
                          <h3>SHIP ADDRESS</h3><h6><b><?php echo strtoupper($nama12); ?></b></h6><hr>
                        <b> Mr.Budi Raharjo</b><br>
                        <?php echo $alamat12; ?>
...
<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Total</td><td><?php echo rupiah($totalg); ?><input type="hidden" id="totalgku" value="<?php echo $totalg; ?>"></td>
  ...
  <tr align="center">
    <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Tax</td><td><input type="text" id="tt" onfocus="hitungtax()"></td>
  </tr>
  <!-- <tr align="center">
<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Delivery Cost</td><td><input type="text"></td>
  </tr> -->
  <tr align="center">
  <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Grand Total</td><td><input type="text" id="gtt" onfocus="hitunggtt()"></td>
  </tr>
  <script>
  function hitunggtt()
  {
    totalgku=parseInt(document.getElementById("totalgku").value);
    tt=parseInt(document.getElementById("tt").value);
    totalsemua=totalgku+tt;
    document.getElementById("gtt").value=totalsemua;
  }
  function hitungtax()
  {
    totalgku=document.getElementById("totalgku").value;
    tax=totalgku*0.01;
    document.getElementById("tt").value=tax;
  }
  function payment()
  {
    a=document.getElementById("paid").value;
    b=document.getElementById("gtt").value;
    c=a-b;
    document.getElementById("change").value=c;
  }
  </script>
  <tr align="center">
     <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Payment</td><td><input type="text" id="paid"></td>
    </tr>
    <tr align="center">
       <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>Change</td><td><input type="text" id="change" onfocus="kembalian()"></td>
      </tr>
      <script>
      function kembalian()
      {
        a=parseInt(document.getElementById("paid").value);
        b=parseInt(document.getElementById("gtt").value);
        c=a-b;
        document.getElementById("change").value=c;
      }
      </script>
      <tr align="center">
         <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><button class="btn btn-info btn-sm btn-block">Pay Now</button></td>
        </tr>
    <!-- <tr>
      <?php
