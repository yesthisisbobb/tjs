              ...
              <div class="row layout-top-spacing">
                ...
                <table id="zero-config" class="table table-hover" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <?php
                      $sql = "SELECT * FROM master_perusahaan ORDER BY id";
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="with-btn" nowrap="">
                        ...
                        <a href="master_perusahaan.php?aksi=view&no=<?php echo $amku["id"]; ?>#section2"><i class="fas fa-edit" style="font-size:18px;color:#5DADE2;" data-toggle="tooltip" title="EDIT" ></i></a>
                          <a href="proses-perusahaan.php?aksi=update&no=<?php echo $amku["id"]; ?>"><i class="fas fa-times-circle"  style="font-size:18px;color:#F8C471;"data-toggle="tooltip" title="DISABLE" ></i></a>
                          <a href="proses-perusahaan.php?aksi=active&no=<?php echo $amku["id"]; ?>"><i class="fas fa-check-circle" style="font-size:18px;color:#52BE80;"data-toggle="tooltip" title="ENABLE" ></i></i></a>
                        <a href="proses-perusahaan.php?aksi=delete&no=<?php echo $amku["id"]; ?>"><i class="fas fa-trash" style="font-size:18px;color:#CD6155;"data-toggle="tooltip" title="DELETE" ></i></i></a>
...
<br>
                                  <div class="col-lg-12 col-12 mx-auto">
                                    <form class="form-horizontal" method="post" action="proses-perusahaan.php">
                                                                ...
                                                                {
                                                                  $nomerku=$_GET['no'];
                                                                  $sql = "SELECT * FROM master_perusahaan where id='$nomerku'";
                                                                       $query = mysqli_query($conn, $sql);
                                                                       while($amku = mysqli_fetch_array($query)){
                                                                         $kodep=$amku['kode'];
                                                                  ...
                                                                  ?>
                                                                        ...
                                                                        <div class="form-group">
                                                                         ...
                                                                         <div>
                                                                 <div class="form-group">
                                                                   <label class="col-sm-10 control-label">Division Code (Kode Divisi)</label>
                                                                   <div class="col-sm-12">
                                                                     <input type="text" class="form-control" id="kode_perusahaan" value="<?php echo $kodep; ?>" name="kode_perusahaan">
                                                                  </div>
                                                                  <div><br>
                                                                  <div class="form-group">
                                                                    <label class="col-sm-6 control-label">Division (Nama Divisi)</label>
                                                                  <div class="col-sm-12">
