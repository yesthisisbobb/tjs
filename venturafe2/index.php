			...
			<section class="featured-hp-1">
				<div class="container">
					<div class="featured-content woocommerce">
						...
						<div class="view-all">
							<a href="#" class="au-btn btn-small">View All<i class="zmdi zmdi-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-5">
							<div class="insta-detail p-4 text-center">
								<h1 class="mb-2"><i class="fa fa-thumbs-o-up"></i></h1>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-5">
							<div class="insta-detail p-4 text-center">
								<h1 class="mb-2"><i class="fa fa-credit-card"></i></h1>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-5">
							<div class="insta-detail p-4 text-center">
								<h1 class="mb-2"><i class="fa fa-truck"></i></h1>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-5">
							<div class="insta-detail p-4 text-center">
								<h1 class="mb-2"><i class="fa fa-undo"></i></h1>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-5">
							<div class="insta-detail p-4 text-center">
								<h1 class="mb-2"><i class="fa fa-home"></i></h1>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-5">
							<div class="insta-detail p-4 text-center">
								<h1 class="mb-2"><i class="fa fa-upload"></i></h1>
