<?php
session_start();
include("../venturafe1/inc/config.php"); //include koneksi database
include("rupiah.php");
?>
<head>
  ...
  <div class="container pl-20 ml-30 mt-10">
    <div class="row">
      ...
      <div class="border col-xl-3">
        <div class="logo pt-2">
          ...
          <p style="font-size:16px;font-family:roboto;">SO.Date : </b><?php echo $tanggal; ?><BR>
            ...
            <b>Sales : </b><?php echo isset($nama13)?$nama13:"No Sales"; ?><br>
      ...
      <div class="border col-xl-3">
        <div class="logo pt-2">
          <h2>CUSTOMER</h2>
          <h6><b><?php echo strtoupper($nama12); ?></b></h6>
          <hr>
          <b style="font-size:20px;font-family:roboto;">Mr.Budi Raharjo</b>
          <p style="font-size:15px;font-family:roboto;">
  ...
  <div class="row">
    <div class=" col-xl-8">
      <div class="logo pt-0 pl-20">
        <b>
          <p style="font-size:18px;font-family:roboto;" class="mb-0"><u>TERM & CONDITION</u>
        </b>
